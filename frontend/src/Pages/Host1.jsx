...
const Host = () => {
    return ( 
        <form class=" pt-24 bg-gradient-to-r from-black to-yellow-200" action="../event_detail.html" method="POST">
            <Navbar />
        <div class=" pl-44">
